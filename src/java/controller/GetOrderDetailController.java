...
public class GetOrderDetailController extends HttpServlet {
    ...
    private static final String SUCCESS = "detail_order.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            OrderDTO odto = dao.getOrderDetail(orderID);
            if (odto != null) {
                request.setAttribute("ORDER_DETAIL", odto);
                int a = odto.getOrderID();
                url = SUCCESS;
